...
function addToCart(e) {
    ...
    let fruit = e.target.id;

    var fruitIdx = fruits.map(function (e) { return e.fruit; }).indexOf(fruit);
    ...
    cart.appendChild(divDesc);
    cart.appendChild(divLocation);
